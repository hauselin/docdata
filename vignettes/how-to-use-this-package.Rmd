---
title: "How to use generate data documentation with doc_data"
author: "Hause Lin"
date: "`r Sys.Date()`"
...
Whenever you share your data with someone (including your future self?), make sure to also share the corresponding documentation. Don't be **that** person who shares undocumentated data!
